...
const text = readFileSync(join(__dirname, '../app/_lib/Thich_Nhat_Hanh.txt'), 'utf8');
...
writeFileSync(join(__dirname, '../app/_lib/tnh-quotes.json'), JSON.stringify(quotes, null, 2));
